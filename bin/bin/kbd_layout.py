...
class Py3status:
    ...
    and is set to 2 seconds (0 would mean no cache).
    """
    ...
    def kbd_layout(self, i3s_output_list, i3s_config):
        """
        ...
        lang = os.popen("/home/m/bin/xkblayout-state print '%s'").read()
        if lang == 'us':
          color = '#009E00'
        else:
          color = '#C60101'
